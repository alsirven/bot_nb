...
export default async (_: BotContext, { state, gotoFlow, extensions }: BotMethods) => {
    ...
    2. HABLAR: Esta acción se debe realizar cuando el cliente desea hacer una pregunta o necesita más información en especial si escribe palabras como informacion, costo, precio, servicios lista de servicios, cuales consultas ofrece.
