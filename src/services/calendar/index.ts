...
const getCurrentCalendar = async (): Promise<string> => {
    const dataCalendarApi = await fetch('https://hook.us1.make.com/faxqs7yg3uqoli8bcyuag4tgvc7qj7r4')
...
const appToCalendar = async (text: string) => {
    try {
        ...
        console.log(payload)
        const dataApi = await fetch('https://hook.us1.make.com/njccip8aqx3257u9a1kmit2j9a1yvcxp', {
            method: 'POST',
            headers: {
